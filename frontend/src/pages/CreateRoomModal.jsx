              ...
              {filteredTopics.map((topic, idx) => (
                <button
                  ...
                  style={{
                    ...
                    padding: '10px 14px',
                    borderRadius: '10px',
                    background: selectedTopic === topic ? 'rgba(99,102,241,0.22)' : 'rgba(255,255,255,0.03)',
                    border: selectedTopic === topic ? '1px solid rgba(99,102,241,0.6)' : '1px solid rgba(255,255,255,0.07)',
                    color: selectedTopic === topic ? '#A5B4FC' : '#D1D5DB',
                    fontSize: '0.85rem',
